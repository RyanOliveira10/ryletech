...
<main>
  <div class="ryle-container">
    ...
    <form action="./cadastro/createAccount.php" method="post">
      ...
      <input type="fone" required name="phone" placeholder="Telefone/Celular" class="ryle-input" id="ryle-input-id-7">
